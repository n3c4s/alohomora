      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        <p className="text-sm font-medium text-blue-600">Dispositivos Conectados</p>
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        <p className="text-sm font-medium text-green-600">Última Sincronización</p>
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        <p className="text-sm font-medium text-purple-600">Método de Sincronización</p>
                  ...
                  <div className="bg-orange-50 p-4 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        <p className="text-sm font-medium text-orange-600">Intervalo de Sincronización</p>
                ...
                {syncStats && (
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <h3 className="text-sm font-medium text-gray-700 mb-2">Total de Sincronizaciones</h3>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <h3 className="text-sm font-medium text-gray-700 mb-2">Datos Sincronizados</h3>
                      <p className="text-2xl font-bold text-gray-900">{formatBytes(syncStats.total_data_synced)}</p>
                      <p className="text-sm text-gray-500">Total acumulado</p>
                    </div>
                    
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <h3 className="text-sm font-medium text-gray-700 mb-2">Última Duración</h3>
                      <p className="text-2xl font-bold text-gray-900">
                        {syncStats.last_sync_duration ? `${syncStats.last_sync_duration}ms` : 'N/A'}
                      </p>
                      <p className="text-sm text-gray-500">Tiempo de sincronización</p>
                    </div>
                  </div>
                )}
            ...
            {activeTab === 'devices' && (
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <h3 className="text-lg font-medium text-gray-900">Dispositivos Descubiertos</h3>
                  <button
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">{device.os} {device.os_version}</p>
                            <p className="text-xs text-gray-500">v{device.app_version}</p>
                          </div>
                        </div>
                ...
                {discoveredDevices.length === 0 && (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500">No se han descubierto dispositivos</p>
                    <button
                      onClick={startDiscovery}
            ...
            {activeTab === 'settings' && (
              <div className="space-y-6">
                <h3 className="text-lg font-medium text-gray-900">Configuración de Sincronización</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          syncConfig.auto_discovery ? 'bg-blue-600' : 'bg-gray-200'
                        }`}
                      >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          syncConfig.auto_sync ? 'bg-blue-600' : 'bg-gray-200'
                        }`}
                      >
                        <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                ...
                <div className="border-t pt-6">
                  <h4 className="font-medium text-gray-900 mb-4">Redes Permitidas</h4>
